  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-semibold text-[var(--on-surface)]">New User</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-[var(--surface-container)] border border-[var(--outline-variant)] rounded-xl p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button type="submit" disabled={loading} className="px-4 py-2 bg-[var(--primary)] text-[var(--on-primary)] rounded-lg text-sm font-medium hover:brightness-110 transition-all disabled:opacity-50">
